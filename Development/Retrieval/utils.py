...
def init_cifar_dataloader(root, batchSize):
    ...
    train_set = ImageFolder('/Users/mac/Downloads/MSEProject/Pytorch-dsh/database/', train_tf)
    valid_set = ImageFolder('/Users/mac/Downloads/MSEProject/Pytorch-dsh/database/', valid_tf)
    #print(train_set.classes)
    #print(train_set.class_to_idx)

    #  DataLoader Iterator
    train_data = DataLoader(train_set, 64, False, num_workers=4)
...
def compute_result(dataloader, net):
    ...
    for img, cls in dataloader:
        ...
        bs.append(net(Variable(img, volatile=True)).data.cpu())
