...
#valid_set = ImageFolder('/Users/mac/Downloads/MSEProject/Pytorch-dsh/database/', valid_tf)
#  DataLoader Iterator
...
#resnet_152.fc.out_features = len(train_set.classes)
#print(len(train_set.classes))
resnet_152.fc = nn.Linear(2048, Output_features)

resnet_152 = torch.nn.DataParallel(resnet_152).cuda()
#resnet_152 = torch.nn.DataParallel(resnet_152)
...
train(resnet_152, train_data, 90, optimizer, criterion)


# save model
print("resnet 152 pretrained model, 90 epochs")
torch.save(resnet_152.state_dict(), "resnet152_1047_pretrained_4gpu_e90.pth.tar")
