...
def main():
    ...
    optimizer = optim.SGD(net.module.classifier.parameters(), lr=1e-3, weight_decay=1e-4, momentum=0.9)
    ...
    for epoch in range(resume_epoch, opt.niter):
        ...
        if epoch % opt.checkpoint == 0:
            ...
            optimizer = optim.SGD(net.module.classifier.parameters(), lr=((1e-3)-epoch*(1e-4)), weight_decay=1e-4, momentum=0.9)
