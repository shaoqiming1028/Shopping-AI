...
Path_dataset = "/media/yang/STEVE/images"
batch_size = 10
num_workers = 4
...
model.classifier = nn.Linear(2208, 1047)
model = torch.nn.DataParallel(model)
params = torch.load('/home/yang/pytorch_project/project/image_retrieval/keep_train/densenet_params/12679217/027.pth')
...
np.savetxt('rng.txt', np.array(res_dataset), fmt='%.6f')
