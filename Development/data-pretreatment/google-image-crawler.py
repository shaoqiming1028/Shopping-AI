...
CONFIGS[u'num_downloads_for_each_class'] = 20
...
CONFIGS[u'search_keywords_dict'] = {'Maggi Oyster Sauce':[u'Maggi Oyster Sauce'],
                                    'Old El Paso Hard \'N Soft Taco Kit':[u'Old El Paso Hard \'N Soft Taco Kit'],
                                    'SomersbyApple Cider 375mL Can': [u'SomersbyApple Cider 375mL Can'],
                                    'True Foods Garlic Naan Bread': [u'True Foods Garlic Naan Bread'],
                                    'Old El Paso Taco Spice Mix': [u'Old El Paso Taco Spice Mix'],
                                    'True Foods Traditional Roti Bread': [u'True Foods Traditional Roti Bread'],
                                    'Old El Paso Stand \'N Stuff Taco Kit': [u'Old El Paso Stand \'N Stuff Taco Kit'],
                                    'True Foods Traditional Naan Bread': [u'True Foods Traditional Naan Bread'],
                                    'Mission White Corn Chips': [u'Mission White Corn Chips'],
                                    'Fountain Soy Sauce': [u'Fountain Soy Sauce'],
                                    'Fountain Hoi Sin Sauce': [u'Fountain Hoi Sin Sauce'],
                                    'Coles Smart Buy Coconut Cream': [u'Coles Smart Buy Coconut Cream'],
                                    'TCC Coconut Milk': [u'TCC Coconut Milk'],
                                    'Coles Tomato Salsa Mild': [u'Coles Tomato Salsa Mild'],
                                    'Kikkoman Soy Sauce': [u'Kikkoman Soy Sauce'],
                                    'TCC Coconut Extract Lite Milk': [u'TCC Coconut Extract Lite Milk'],
                                    'Old El Paso Fajita Spice Mix': [u'Old El Paso Fajita Spice Mix'],
                                    'Mission Cheesy Nachos Corn Chips': [u'Mission Cheesy Nachos Corn Chips'],
                                    'Loacker Gran Pasticceria Tortina Original': [u'Loacker Gran Pasticceria Tortina Original'],
                                    'Old El Paso Refried Beans': [u'Old El Paso Refried Beans'],
                                    'Valcom Sliced Water Chestnuts': [u'Valcom Sliced Water Chestnuts'],
                                    'Ayam Coconut Milk': [u'Ayam Coconut Milk'],
                                    'Ayam Coconut Cream': [u'Ayam Coconut Cream'],
                                    'Indomie Mi Goreng Noodles': [u'Indomie Mi Goreng Noodles'],
                                    'Valcom Rice Paper 22cm': [u'Valcom Rice Paper 22cm'],
                                    'Coles Oyster Sauce': [u'Coles Oyster Sauce'],
                                    'Obento Panko Breadcrumbs': [u'Obento Panko Breadcrumbs'],
                                    'Maharajah\'s Choice Plain Pappadums': [u'Maharajah\'s Choice Plain Pappadums'],
                                    'Pearl River Bridge Light Soy Sauce': [u'Pearl River Bridge Light Soy Sauce'],
                                    'Obento Yaki Nori Seaweed Sushi Sheets': [u'Obento Yaki Nori Seaweed Sushi Sheets'],
                                    'Old El Paso Taco Shells': [u'Old El Paso Taco Shells'],
                                    'Valcom Sliced Bamboo Shoots': [u'Valcom Sliced Bamboo Shoots'],
                                    'Ayam Thai Green Curry Paste': [u'Ayam Thai Green Curry Paste'],
                                    'Five Tastes Massaman Paste': [u'Heinz Mild American Mustard'],
                                    'Obento Rice Wine Vinegar': [u'Obento Rice Wine Vinegar'],
                                    'Yoosh Aloe Vera Drink': [u'Yoosh Aloe Vera Drink'],
                                    'Bisto Plain Gravy Granules': [u'Bisto Plain Gravy Granules'],
                                    'Coles Mexican Sauce': [u'Coles Mexican Sauce'],
                                    'Fountain Gluten Free Soy & Honey Sauce': [u'Fountain Gluten Free Soy & Honey Sauce'],
                                    'Lee Kum Kee Singapore Noodle Sauce': [u'Lee Kum Kee Singapore Noodle Sauce'],
                                    'Mae Ploy Sweet Chilli Sauce': [u'Mae Ploy Sweet Chilli Sauce'],
                                    'Mission Taco Dinner Kit': [u'Mission Taco Dinner Kit'],
                                    'Valcom Red Curry Paste': [u'Valcom Red Curry Paste'],
                                    'Nong Shim Onion Rings': [u'Nong Shim Onion Rings'],
                                    'Dr Pepper Drink Can': [u'Dr Pepper Drink Can'],
                                    'Kewpie Japanese Roasted Sesame Dressing': [u'Kewpie Japanese Roasted Sesame Dressing'],
                                    'Lee Kum Kee Premium Soy Sauce': [u'Lee Kum Kee Premium Soy Sauce'],
                                    'Six Fortune Rice Crackers': [u'Six Fortune Rice Crackers'],
                                    'Indomie Mi Goreng Hot & Spicy Noodles': [u'Indomie Mi Goreng Hot & Spicy Noodles'],
                                    'Nong Shim Oriental Style Kim Chee Noodles': [u'Nong Shim Oriental Style Kim Chee Noodles']
...
CONFIGS[u'save_dir'] = './Entertaining at Home'

CONFIGS[u'output_prefix'] = ''
CONFIGS[u'output_suffix'] = ''
...
for class_name,search_keywords in CONFIGS[u'search_keywords_dict'].iteritems():
    ...
    class_urls_file_prefix = CONFIGS[u'output_prefix'] + str(class_name).strip()
    ...
    class_save_dir = osp.join(CONFIGS[u'save_dir'], class_urls_file_prefix + CONFIGS[u'output_suffix'])
